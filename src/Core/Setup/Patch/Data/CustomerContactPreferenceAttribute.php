...
use Maginium\Customer\Models\Config\Source\ContactPreference;
...
/**
 * Class CustomerContactPreferenceAttribute.
 *
 * Defines and configures a custom attribute for storing the customer's contact preference.
 ...
 */
class CustomerContactPreferenceAttribute extends Migration
{
    /**
     * The code identifier for the attribute.
     */
    public static string $attribute = 'contact_preference';
     ...
     */
    public const ATTRIBUTE_LABEL = 'Contact Preference';

    /**
     * The default value for the attribute.
     */
    public const ATTRIBUTE_DEFAULT_VALUE = 'email';
    ...
    public function up(): void
    {
        ...
        AttributeSchema::create(static::$attribute, function(AttributeBlueprint $attribute): void {
            $attribute->asVarchar()
                ...
                ->source(ContactPreference::class);
        });
    }
}
